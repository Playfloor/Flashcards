...
\Card{equivalent metrics}{
    Two metrics $d_1$, $d_2$ are called \mbox{\textbf{equivalent}} iff
    they have the same open sets.
}

\Card[Lemma]{Two metrics $d_1$, $d_2$ are equivalent iff\dots}{
    \dots the identity map $id: (X,d_1) \rightarrow (X,d_2)$ is a homeomorphism.
}
